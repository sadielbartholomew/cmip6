...
export CMIP6_INSTITUTION_ID_RAW=(
	'AER'
	'AS-RCEC'
	'AWI'
	'BCC'
...
export CMIP6_EXPERIMENT_ID_RAW=(
	'1pctCO2'
	'1pctCO2-4xext'
	'1pctCO2-bgc'
	'1pctCO2-cdr'
...
export CMIP6_REALM_SPECIALIZATIONS=(
	'aerosol'
	'atmos'
	'atmoschem'
	'land'
